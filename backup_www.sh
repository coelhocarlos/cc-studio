...
#exlude folder $ tar --exclude='./folder' --exclude='./upload/folder2' -zcvf /backup/filename.tgz .
tar  --exclude="/var/www/clients/client1/web2/web/cloud" --exclude="/var/www/clients/client1/web2/web/cloudext" -cvzf  "$ARQUIVO"  /var/www/clients/;
#Envia o Arquivo para o Mega.
megaput "$ARQUIVO" --path=/Root/CCTSTUDIOWEB
